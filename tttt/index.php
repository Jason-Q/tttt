...
$jssdk = new JSSDK("wxda88490ea3bce3a8", "5fe2ca45c13fcdaeddaca6c0dbf37706");//填写开发者中心你的开发者ID
...
<title>html5中秋节吃月饼游戏 - 网站源码</title>     	 
...
<style type="text/css">
body {font-family: "Helvetica Neue", Helvetica, STHeiTi, sans-serif; margin: 0; padding: 0;background:url(images/bg.png) left top repeat-y;background-size:100%;}
...
#GameLayerBG {top:0;left:0;right:0;bottom:0;overflow:hidden;}
.GameLayer {position:absolute;bottom:0;left:0;}
.block {position:absolute;background-repeat: no-repeat; background-position: center;}
.t1,.t2,.t3,.t4,.t5 { background-size:auto 100%;background-image:url(images/rmb.png);}
.tt1,.tt2,.tt3,.tt4,.tt5 { background-size:auto 86%;background-image:url(images/laugh.gif);}
...
<script type="text/javascript">
	window.shareData = {
	        "imgUrl": "fengmian.png",
	        "timeLineLink": "http://g.huceo.com/weixin/chiyuebing",
	...
	var mebtnopenurl = 'http://g.huceo.com/weixin/chiyuebing';
...
<DIV class="BBOX SHADE bgc1" id="GameScoreLayer" style="display: none;">
	<DIV style="padding: 0px 5%;">
		...
		<DIV class="BOX" id="GameScoreLayer-share">
			<DIV class="btn BOX-S" id="mebtn" onclick="window.open(mebtnopenurl)">土豪点我！</DIV>
		</DIV>
	</DIV>
</DIV>
...
<DIV class="SHADE BOX-M" id="welcome">
	...
	<DIV class="FILL BOX-M" style="left: 0px; top: 0px; right: 0px; bottom: 0px; position: absolute; z-index: 5;">
		<DIV style="margin: 0px 8% 0px 9%;">
			<DIV style="color: rgb(254, 240, 2); font-size: 2.6em;">吃月饼大赛</DIV>
			<BR>
			<DIV style="color: rgb(255, 255, 255); line-height: 1.5em; font-size: 2.2em;">中秋快乐！</DIV>
			<BR><BR>
